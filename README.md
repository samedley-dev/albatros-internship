...
В данных могут иметься статистические выбросы. Для их обработки была реализована функция `processed_df(filename)`, возвращающая пандас-датафрейм, содержащий данные о продажах, очищенные от выбросов. Ниже приведена реализация данной функции в файле `outlier_processing.py`.
